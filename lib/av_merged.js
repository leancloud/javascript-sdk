...
(function(root) {
  ...
  /**
   * @class A AV.File is a local representation of a file that is saved to the AV
   * cloud.
   * @param name {String} The file's name. This will change to a unique value
   *     once the file has finished saving.
   * @param data {Array} The data for the file, as either: <pre>
   *     1. an Array of byte value Numbers, or
   *     2. an Object like { base64: "..." } with a base64-encoded String.
   *     3. a File object selected with a file upload control. (3) only works
   *        in Firefox 3.6+, Safari 6.0.2+, Chrome 7+, and IE 10+.
   *        For example:
   *     4.a Buffer object in Node.js runtime.</pre><pre>
...
(function(root) {
  ...
  _.extend(AV.Object.prototype, AV.Events,
    ...
    */
   AV.Object.createWithoutData = function(className, id){
