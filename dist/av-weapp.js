...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      */
    ...
    }, { "./index.js": 23, "./localstorage.js": 24, "./websocket.js": 25, "./xmlhttprequest.js": 26 }], 23: [function (require, module, exports) {
      (function (global) {
    ...
    }, { "./localstorage.js": 24, "./websocket.js": 25, "./xmlhttprequest.js": 26 }], 24: [function (require, module, exports) {
    ...
    }, { "event-target-shim": 9 }], 26: [function (require, module, exports) {
      var EventTarget = require('event-target-shim');
          ...
          value: function send(data) {
            ...
            wx.request({
              ...
              success: function success(response) {
                _this3.status = response.statusCode;
                _this3.statusText = response.statusCode;
                var text = response.data;
                if (typeof text !== 'string') {
                  text = JSON.stringify(text);
                }
                _this3.responseText = _this3.response = text;
                _this3.readyState = DONE;
                _this3.dispatchEvent({ type: 'readystatechange' });
              },
    ...
    }, { "underscore": 21 }], 28: [function (require, module, exports) {
      (function (process, global) {
        var _ = require('underscore');
    ...
    }, { "./utils": 56, "_process": 15, "underscore": 21 }], 29: [function (require, module, exports) {
      (function (global) {
        var _ = require('underscore');
    ...
    }, { "../promise": 44, "localstorage-memory": 12, "react-native": 1, "underscore": 21 }], 30: [function (require, module, exports) {
    ...
    }, { "./av": 28, "./localstorage": 41 }], 32: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./request": 48, "underscore": 21 }], 33: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 34: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./browserify-wrapper/parse-base64": 30, "./error": 33, "./promise": 44, "./request": 48, "./uploader/cos": 52, "./uploader/qiniu": 53, "./uploader/s3": 54, "underscore": 21 }], 36: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 37: [function (require, module, exports) {
      require('weapp-polyfill/auto-polyfill');

      module.exports = require('./index');
    }, { "./index": 38, "weapp-polyfill/auto-polyfill": 22 }], 38: [function (require, module, exports) {
      /*!
       ...
       */
    }, { "./acl": 27, "./av": 28, "./cache": 31, "./cloudfunction": 32, "./error": 33, "./event": 34, "./file": 35, "./geopoint": 36, "./init": 39, "./insight": 40, "./localstorage": 41, "./object": 42, "./op": 43, "./promise": 44, "./push": 45, "./query": 46, "./relation": 47, "./role": 49, "./search": 50, "./status": 51, "./user": 55, "./version": 57, "underscore": 21 }], 39: [function (require, module, exports) {
      var AV = require('./av');
    ...
    }, { "./av": 28, "./request": 48 }], 40: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 33, "./request": 48, "underscore": 21 }], 41: [function (require, module, exports) {
      var _ = require('underscore');
      var Promise = require('./promise');
    ...
    }, { "./browserify-wrapper/localStorage": 29, "./promise": 44, "underscore": 21 }], 42: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 33, "./request": 48, "./utils": 56, "underscore": 21 }], 43: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 44: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "rsvp": 16, "underscore": 21 }], 45: [function (require, module, exports) {
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 48 }], 46: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 33, "./request": 48, "./utils": 56, "underscore": 21 }], 47: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "./av": 28, "./cache": 31, "./error": 33, "./promise": 44, "./utils": 56, "_process": 15, "debug": 5, "md5": 13, "superagent": 17, "underscore": 21 }], 49: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
    ...
    }, { "./error": 33, "underscore": 21 }], 50: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 48, "underscore": 21 }], 51: [function (require, module, exports) {
      var _ = require('underscore');
      var AVRequest = require('./request').request;
    ...
    }, { "./request": 48, "underscore": 21 }], 52: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 44, "debug": 5, "superagent": 17 }], 53: [function (require, module, exports) {
      var request = require('superagent');
      var Promise = require('../promise');
    ...
    }, { "../promise": 44, "debug": 5, "superagent": 17 }], 54: [function (require, module, exports) {
      var request = require('superagent');
    ...
    }, { "../promise": 44, "superagent": 17 }], 55: [function (require, module, exports) {
      var _ = require('underscore');
      var AVError = require('./error');
      var AVRequest = require('./request').request;
    ...
    }, { "./error": 33, "./request": 48, "underscore": 21 }], 56: [function (require, module, exports) {
      var _ = require('underscore');
    ...
    }, { "underscore": 21 }], 57: [function (require, module, exports) {
