...
var polyfill = __webpack_require__(23).polyfill;
window = window || {};
polyfill();
polyfill(window);
try {
  localStorage = localStorage || __webpack_require__(13);
} catch (e) {}
try {
...
module.exports = function (AV) {
  ...
  AV.File = function (name, data, mimeType) {
    ...
    if (data && data.base64) {
      var parseBase64 = __webpack_require__(46);
...
var comments = ["Weapp" || 'Node.js'].concat(__webpack_require__(39));
