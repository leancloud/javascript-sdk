...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
        ...
        AV.Status.prototype = {
          ...
          send: function send() {
            ...
            return getUserPointer(options).then(function (currUser) {
              var query = _this6.query.toJSON();
              query.className = _this6.query.className;
              var data = {};
              data.query = query;
              _this6.data = _this6.data || {};
              _this6.data.source = _this6.data.source || currUser;
              data.data = _this6._getDataJSON();
              data.inboxType = _this6.inboxType || 'default';

              return AVRequest('statuses', null, null, 'POST', data, options.sessionToken);
            }).then(function (response) {
              _this6.id = response.objectId;
              _this6.createdAt = AV._parseDate(response.createdAt);
              return _this6;
            });
          },
        ...
        AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
          ...
          _linkWith: function _linkWith(provider, data) {
            ...
            if (data) {
              ...
              return provider.authenticate().then(function (result) {
                return _this7._linkWith(provider, result);
              });
            }
          },
          ...
          linkWithWeapp: function linkWithWeapp() {
            ...
            return getWeappLoginCode().then(function (code) {
              return _this8._linkWith('lc_weapp', { code: code });
            });
          },
          ...
          loginWithWeapp: function loginWithWeapp() {
            ...
            return getWeappLoginCode().then(function (code) {
              return _this11.signUpOrlogInWithAuthData({ code: code }, 'lc_weapp');
            });
          },
    ...
    }, { "./error": 24, "./promise": 34, "./request": 38, "underscore": 17 }], 46: [function (require, module, exports) {
      var _ = require('underscore');
