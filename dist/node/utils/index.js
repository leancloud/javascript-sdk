...
var inherits = function inherits(parent, protoProps, staticProps) {
  ...
  try {
    for (var _iterator = Object.getOwnPropertyNames(parent)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var prop = _step.value;

      var propertyDescriptor = Object.getOwnPropertyDescriptor(parent, prop);
