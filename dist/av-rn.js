...
var comments = ["ReactNative" || 'Node.js'].concat(__webpack_require__(37));
...
module.exports = function upload(uploadInfo, data, file) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (__webpack_require__(13) && data instanceof __webpack_require__(13)) {
      // data.pipe(req);
...
var AsyncStorage = __webpack_require__(57).AsyncStorage;
